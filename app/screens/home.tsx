...
// const $topContainer: ViewStyle = {
//   flexDirection: "column", // 👈 switch from "row" to "column"  gap: 18,
//   borderWidth: 1,
// borderColor: "green",
// }
...
//     marginTop: 0,
//       marginBottom: 0,       // 👈 Adds a soft gap before Check-In section
//        borderWidth: 2, 
//         borderColor: "green", 
...
// >
//     <View style={$topContainer}>
//           <View style={{ width: "100%", height: 80, backgroundColor: "lightblue" }}
          
//           onLayout={(event) => {
//     console.log("Header height:", event.nativeEvent.layout.height)
//     console.log("Header Y position:", event.nativeEvent.layout.y)
//     console.log("Calendar container height:", event.nativeEvent.layout.height);
//     console.log("Calendar container Y:", event.nativeEvent.layout.y);
//     console.log("SafeAreaView height:", event.nativeEvent.layout.height);
//     console.log("SafeAreaView Y position:", event.nativeEvent.layout.y);
//      console.log("🧊 Calendar Y:", event.nativeEvent.layout.y);
//     console.log("🧊 Calendar height:", event.nativeEvent.layout.height);
//   }}>
...
//     console.log("Header height:", event.nativeEvent.layout.height)
//     console.log("Header Y position:", event.nativeEvent.layout.y)
//        console.log("🟠 Coral header Y:", event.nativeEvent.layout.y);
//     console.log("🟠 Coral header height:", event.nativeEvent.layout.height)
//   }}>
//           <View style={$imageContainer}>
...
//     $container,
//     { paddingTop: 0, marginTop: 0, gap: 0, backgroundColor: "pink",}
//   ]}
//    onLayout={(e) => {
//     console.log("🧾 Screen content Y:", e.nativeEvent.layout.y);
//   }}
// >
//       <BottomSheetModalProvider>
...
//             }}
//               onLayout={(e) => {
//     console.log("📦 Check-In Y:", e.nativeEvent.layout.y);
//     console.log("📦 Check-In height:", e.nativeEvent.layout.height);
//   }}>
//           <Text tx="homeScreen.check_in" preset="subheading" />
//           <View>
//             <ScrollView
